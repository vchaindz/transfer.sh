# transfer.sh [![Go Report Card](https://goreportcard.com/badge/github.com/vchaindz/transfer.sh)](https://goreportcard.com/report/github.com/vchaindz/transfer.sh) [![Docker pulls](https://img.shields.io/docker/pulls/dutchcoders/transfer.sh.svg)](https://hub.docker.com/r/dutchcoders/transfer.sh/) [![Build Status](https://github.com/vchaindz/transfer.sh/actions/workflows/test.yml/badge.svg?branch=main)](https://github.com/vchaindz/transfer.sh/actions/workflows/test.yml?query=branch%3Amain)
